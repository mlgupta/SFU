...
public class JobCreator {
  ...
  JobDataMap createMailData(String to, String from, String cc, String bcc,
                            String subject, String message, String creator,
                            String smtpHost, Date startTime,
                            String retrial_count, String retrial_interval,
                            String max_count, String error_mesg,
                            String parentFolder, ArrayList fileList) {
    ...
    mailData.put(SchedulerConstants.PARENT_FOLDER, parentFolder);
    mailData.put(SchedulerConstants.PROP_ATTACHMENTS, fileList);
    return mailData;
  }

  public JobDataMap createDocUploadData(String creator, Date startTime,
                                        String retrial_count,
                                        String retrial_interval,
                                        String max_count, String error_mesg,
                                        ArrayList fileList,
                                        String parentFolder,
                                        String destinationFolder) {
    JobDataMap docUploadData = new JobDataMap();
    docUploadData.put(SchedulerConstants.JOB_CREATOR, creator);
    docUploadData
    .put(SchedulerConstants.JOB_TYPE, SchedulerConstants.UPLOAD_JOB);
    docUploadData.put(SchedulerConstants.EXECUTION_TIME, startTime);
    docUploadData.put(SchedulerConstants.CREATE_TIME, new Date());
    //docUploadData.put(SchedulerConstants.PROP_SMTP_HOST,smtpHost);
    //docUploadData.put(SchedulerConstants.PROP_RECIPIENT,to);
    //docUploadData.put(SchedulerConstants.PROP_CC_RECIPIENT,cc);
    //docUploadData.put(SchedulerConstants.PROP_BCC_RECIPIENT,bcc);
    //docUploadData.put(SchedulerConstants.PROP_SENDER,from);
    //docUploadData.put(SchedulerConstants.PROP_SUBJECT,subject);
    //docUploadData.put(SchedulerConstants.PROP_MESSAGE,message);
    docUploadData.put(SchedulerConstants.RETRIAL_COUNT, retrial_count);
    docUploadData.put(SchedulerConstants.RETRIAL_INTERVAL, retrial_interval);
    docUploadData.put(SchedulerConstants.MAX_COUNT, max_count);
    docUploadData.put(SchedulerConstants.ERROR_MESG, error_mesg);
    docUploadData.put(SchedulerConstants.PROP_DOCUMENTS, fileList);
    docUploadData.put(SchedulerConstants.PARENT_FOLDER, parentFolder);
    docUploadData
    .put(SchedulerConstants.PROP_DESTINATION_FOLDER, destinationFolder);
    return docUploadData;
  }
  ...
  /**
     ...
     */
  public JobDataMap createFaxData(String to, String from, String companyName,
                                  String faxNo, String comments,
                                  Date startTime, String creator,
                                  String retrial_count,
                                  String retrial_interval, String max_count,
                                  String error_mesg, String parentFolder,
                                  ArrayList fileList) {
    ...
    faxData.put(SchedulerConstants.RETRIAL_INTERVAL, retrial_interval);
    faxData.put(SchedulerConstants.MAX_COUNT, max_count);
    faxData.put(SchedulerConstants.PARENT_FOLDER, parentFolder);
    faxData.put(SchedulerConstants.PROP_ATTACHMENTS, fileList);
    faxData.put(SchedulerConstants.ERROR_MESG, error_mesg);
    return faxData;
  }
