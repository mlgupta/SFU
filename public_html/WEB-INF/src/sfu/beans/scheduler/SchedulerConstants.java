...
public class SchedulerConstants 
{
    ...
    public static final String PROP_DESTINATION_FOLDER = "destination_folder";
    ...
    public static final String REPLICATE_JOB_NAME="replicate_job";
    public static final String REPLICATE_TRIGGER_NAME="replicate_trigger";
    public static final String REPLICATE_PERIOD="43200000";
