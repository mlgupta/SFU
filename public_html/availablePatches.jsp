...
<html:form action="availablePatchesAction.do">
      ...
      <tr>
		...
		<table width="745" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="55"><a href="availablePatchesAction.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Patches','','images/tab_patches_ovr.gif',1)"><img src="images/tab_patches.gif" alt="Patches" name="Patches" width="55" height="25" border="0"></a></td>
		...
		<table id="2ndLevelTags" width="725" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="40px" colspan="3" valign="bottom" >			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="bdrBottomColor_336666">&nbsp;</td>
                <td width="100"><a href="availablePatches.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Available Patches','','images/tab_avl_patches_ovr.gif',1)"><img src="images/tab_avl_patches.gif" alt="Available Patches" name="Available Patches" width="100" height="25" border="0"></a></td>
                <td width="100" class="bdrBottomColor_336666"><a href="patchHistory.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Patch History','','images/tab_patch_history_ovr.gif',1)"><img src="images/tab_patch_history.gif" alt="Patch History" name="Patch History" width="100" height="25" border="0"></a></td>
              </tr>
            </table></td>
            </tr>
          <tr>
            <td height="40px" colspan="3" class="bdrLeftColor_336666 bdrRightColor_336666 tr_C5E2E5">
			<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="right">
                    <input name="button" type="button" class="buttons" style="width:80px;" value="<bean:message key="btn.ApplyPatch"/>">
                    <input name="submit22" type="submit" class="buttons" style="width:60px;" value="<bean:message key="btn.Delete"/>">
                  </div>
          ...
          <tr>
            <td height="90px" colspan="3" valign="top" class="bdrLeftColor_336666 bdrRightColor_336666 tr_C5E2E5"><table width="98%"  border="0" align="center" cellpadding="1" cellspacing="0" class="borderClrLvl_2">
              <tr>
          ...
          <tr>
        <td height="235px" align="center" valign="top" class="bdrLeftColor_336666 bdrRightColor_336666 tr_C5E2E5">
			
			<div  align="center" style="overflow:auto; height:235px; width:705px;" frameborder="0" class="bdrColor_336666">
			  <table width="100%" align="center" cellpadding="3" cellspacing="2">
                <tr>
                  <th width="4%">&nbsp;</th>
                  <th width="25%"><div align="center">
                ...
                <tr>
                  ...
                  <td width="25%">wwwwwwwwwwwwwww</td>
                  <td width="20%">No_32746372 tera </td>
                  <td width="14%">88/88/8888</td>
                  <td width="14%">88/88/8888</td>
                  <td width="23%">Description about Patch </td>
                </tr>
                <tr class="tr_C5E2E5">
                  <td width="4%">
                    <input type="radio"/>
                  </td>
                  <td width="25%">qqqqqqqqqqqqqqqqqqqqqq</td>
                  <td width="20%">&nbsp;</td>
                  <td width="14%">&nbsp;</td>
                  <td width="14%">&nbsp;</td>
                  <td width="23%">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td width="25%">eeeeeeeeeeeeeeeeeee</td>
                  <td width="20%">&nbsp;</td>
                  <td width="14%">&nbsp;</td>
                  <td width="14%">&nbsp;</td>
                  <td width="23%">&nbsp;</td>
		  ...
		  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="11%"><div align="right">
                <input name="submit2" type="submit" class="buttons" style="width:60px;" value="OK">
              </div></td>
            </tr>
          </table></td>
      </tr>
