...
function ShowCalendar(theDate){
	...
	varCal ="<table border='0'  cellspacing='2' cellpadding='1' class='imgData bdrColor_336666 bgColor_D8EAEC' width='"+ this.calWidth + "px' >";	
  //Timezone combo 
	if(!this.noTimezone){
    varCal += "<tr>";
    if (eval(this.timezoneDisabled)){
      ...
      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='display:none; width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='bdrColor_336666 componentstyle' title='"+ this.tooltipTimezone +"' >";
      varCal += this.optionsTZ;
      varCal += "</select>";
      varCal += "</th>";
    }else{
      varCal += "<td colspan='7' align='center' class='bdrColor_336666' >";
      varCal += "<select id='"+ this.calId + "cboTZ' name='"+ this.calId + "cboTZ' style='width:"+ (this.calWidth-10) + "px' onchange='"+ this.calId + ".tzOnChange()' class='bdrColor_336666 componentstyle' title='"+ this.tooltipTimezone +"' >";
      varCal += this.optionsTZ;
      varCal += "</select>";
      varCal += "</td>";
    }
	...
	for ( var r = 1; r <= 6; r++ ) {
      ...
      //Current Month Dates cells 
            ...
            cellPrefix="<th " 	
						...
						cellPrefix= "<td class='bdrColor_336666 bgColor_D8EAEC' ";
						cellSuffix="</td>";	
				}
  ...
  if(!this.noTime){
    ...
    varCal += "<select id='"+ this.calId + "cboHH' name='"+ this.calId + "cboHH' style='width:38x' class='bdrColor_336666 componentstyle' title='"+ this.tooltipHour +"' >";
    varCal += this.options24;
    varCal += "</select>:";
    varCal += "<select id='"+ this.calId + "cboMM' name='"+ this.calId + "cboMM' style='width:38px' class='bdrColor_336666 componentstyle' title='"+ this.tooltipMinute +"' >";
    varCal += this.options60;
    varCal += "</select>:";
    varCal += "<select id='"+ this.calId + "cboSS' name='"+ this.calId + "cboSS' style='width:38px' class='bdrColor_336666 componentstyle' title='"+ this.tooltipSecond +"' >";
    varCal += this.options60;
    varCal += "</select>";
    varCal += "</td>";
  }else{
...
function drawDatePicker(){
  ...
  // Default width is different if timezone and time measurement is not requried
	...
	document.write("<tr>");
	document.write("<td>");
	document.write("<input type='text' style='cursor:pointer;cursor:default; width:" + (this.calWidth-15) + "px; height:" + this.calHeight + "px;' class='bdrColor_336666 componentstyle componentstyleDisable' id='" + this.calId + "txtDate' name='" + this.calId + "txtDate' ")
