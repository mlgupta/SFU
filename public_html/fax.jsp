...
<html>
  <head>
    ...
    <script>
      function window_onload(){
        thisForm=document.forms[0];
        MM_preloadImages('images/bt_home_ovr.jpg','images/bt_refresh_ovr.jpg','images/tab_doc_upload_ovr.gif','images/tab_mail_ovr.gif')
  ...
  <body onLoad="return window_onload();">
    <table id="outerMost" width="765px" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>
          <table id="topBar" width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="250">
                <img src="images/sfu_logo.jpg" width="250" height="50"/>
              </td>
                ...
                <table width="725" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100" class="bdrBottomColor_336666">
                      <a href="uploadB4Action.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('DocUpload','','images/tab_doc_upload_ovr.gif',1)">
                        <img src="images/tab_doc_upload.gif" alt="Doc Upload" name="DocUpload" width="100" height="25" border="0"/>
                      </a>
                    </td>
                    <td width="55" class="bdrBottomColor_336666">
                      <a href="mailB4Action.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Mail','','images/tab_mail_ovr.gif',1)">
                        <img src="images/tab_mail.gif" alt="Mail" name="Mail" width="55" height="25" border="0"/>
                      </a>
                    </td>
                    <td width="55">
                      <img src="images/tab_fax.gif" alt="Fax" name="Fax" width="55" height="25" border="0"/>
                    </td>
            ...
            <tr>
              <td height="450px" class="bdrLeftColor_336666 bdrBottomColor_336666 bdrRightColor_336666">
                <html:form action="faxAction.do">
                  ...
                  <html:hidden name="faxForm" property="smtpHost"  />
                  <br/>
                  <table width="65%" border="0" align="center" class="bdrColor_336666">
                    ...
                    <tr>
                      ...
                      <td width="77%">
                        ...
                        <bean:message key="lbl.AllDocuments"/>                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        ...
                        <html:text  property="txtDocNo" styleClass="bdrColor_336666" size="2" onkeypress="return integerOnly(event);" maxlength="2" />         <bean:message key="lbl.Documents"/>                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    ...
                    <td>
                      <table width="99%"  border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <bean:message key="lbl.DocumentsNamedAs"/></td>
                              <td width="189px">
                              <input name="txtName" type="TEXT" class="bdrColor_336666" style="width:146px">						  </td>
                            </tr>
                      </table>					  </td>
                  </tr>
            <tr>
              ...
              <td>
                ...
                <bean:message key="lbl.AutoNaming"/>              </td>	
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td>
                          <span style="float:left; margin-right:10px"><bean:message key="lbl.FaxDate&Time" />:</span>
                            <script>datePicker.render();</script>
                            <html:hidden name="faxForm" property="txtSendTime" />
                      </td>
                      <td width="1%">&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <html:text  property="txtTo" styleClass="bdrColor_336666" style="width:300px;"  /></td>
                    </tr>
                    <tr>
                      <td align="right">
                      ...
                      <td>
                        <html:text property="txtCompanyName" styleClass="bdrColor_336666" size="10" style="width:300px"/>                      </td>
                    </tr>
                    <tr>
                      <td align="right">
                      ...
                      <td>
                        <html:text property="txtFaxNumber" styleClass="bdrColor_336666" size="10" style="width:300px"/>                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <textarea name="txaFax" rows="5" style="width:300px"></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div align="right">
                          ...
                          <html:cancel  styleClass="buttons"  style="width:60px; margin-right:50px"><bean:message key="btn.Cancel" /></html:cancel>
                        </div>
                      </td>
                    </tr>
                    <tr>
