...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      navBar.onclick="callPage('page_scheduler_user')";
    ...
    function callPage(relayOperation){
      ...
      if( (relayOperation!="search_scheduler_user") && (relayOperation!="page_scheduler_user")){
        if(checkSelected(thisForm)){
          if(relayOperation=="job_delete_user"){
    ...
    function document_onkeypress(e){
      ...
      if(key==13 && MM_findObj('tblSearch').style.display!='none'){
        callPage('search_scheduler_user');
      }
    }
  ...
  <body onLoad="return window_onload();">
    <html:form name="jobListForm" type="sfu.actionforms.JobListForm" action="jobRelayAction.do">
      ...
      <table id="outerMost" width="900px" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="785px">&nbsp;</td>
        </tr>
        <tr>
          <td>
            <table id="topBar" width="100%"  height="50px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="250px">
                  <img src="images/sfu_logo.jpg" alt="CDATA" width="250px" height="50"/>
                </td>
                <td valign="bottom" background="images/tile_topbar.jpg">
                  ...
                  <!--
                    <a href="login.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Home','','images/bt_home_ovr.jpg',1)">
                      <img src="images/bt_home.jpg" alt="Home" name="Home" width="52px" height="40" border="0"/>
                    </a>
                  
                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Refresh','','images/bt_refresh_ovr.jpg',1)">
                      <img src="images/bt_refresh.jpg" alt="Refresh" name="Refresh" width="52px" height="40" border="0"/>
                    </a>
                    -->
                    <a href="logoutAction.do"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Logout','','images/bt_logout_ovr.jpg',1)">
                      <img src="images/bt_logout.jpg" alt="Logout" name="Logout" width="52px" height="40" border="0">
                    </a>
                  </div>
                </td>
                <td width="13px">
                  <img src="images/topbar_right.jpg" width="13px" height="50"/>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table width="850px" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="40px" class="bdrLeftColor_336666 bdrRightColor_336666">
                  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="57%">
                        <input name="Button" type="button" class="buttons" style="width:80px;" value="Reschedule" onClick="return callPage('job_reschedule_user')"/>
                        <!--&lt;input name=&quot;Button2&quot; type=&quot;button&quot; class=&quot;buttons&quot; style=&quot;width:90px;&quot; value=&quot;View Content&quot; onclick=&quot;return callPage('view_content')&quot;/&gt;-->
                        <input name="submit2" type="button" class="buttons" style="width:60px;" value="Delete" onClick="return callPage('job_delete_user')"/>
                      </td>
                      <td width="43%">
                        <div align="right">
                          <input name="Button" type="button" class="buttons" style="width:80px;" value="Search" onClick="return callPage('search_scheduler_user')"/>
                        </div>
                      </td>
                    </tr>
                  </table>
                          ...
                          <table width="202px" border="0" id="tblSearch" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                              ...
                              <td width="71%" align="right">
                                ...
                                <html:button property="btnSearchByUserName" styleClass="buttons" title="Select user..." style="width:20px; height:17px" value="..." disabled="true"  />
                              </td>
                            </tr>
                            <tr>
                              <td>
              ...
              <tr>
                <td height="290px" align="center" valign="top" class="bdrLeftColor_336666 bdrRightColor_336666">
                  <div align="center" style="overflow:auto; height:300px; width:830px; margin-top:3px" frameborder="0" class="bdrColor_336666">
