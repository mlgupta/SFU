...
function DrawBar(){
	...
	document.write("<input type='text'  id='" + this.barId+ "txtPageNo' name='" + this.barId+ "txtPageNo' class='bdrColor_336666 componentstyle' style='text-align:right; width:100%'  size='3' onkeypress='return integerOnly(event);' value='" + this.pageNumber + "' title='"+this.tooltipPageNo+"' >");
	document.write("</td>");
	document.write("<td width='30px' align='center' >");
