...
{ 
  ...
  //if (!(folder.isOpen4List)){                      
    ...
    window.location.replace("folderDocFolderClickAction.do?currentFolderId="+ folderId  );		 //Added By Sudheer    
  //}
...
{ 
  ...
  if ((folderObj.isOpen) )				
    if (!(folderObj.isNextLevel) ){
      window.location.replace("folderDocTreeAppendAction.do?currentFolderId="+ folderId + "&parentFolderId=" + folderObj.parentObj.getID());	
      }
}
