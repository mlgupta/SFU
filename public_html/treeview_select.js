...
{ 
  ...
  //alert(document.forms[0].hdnRootFolder.value)
  if(trim(folder.path).length!=0){
    document.forms[0].hdnFolderDocument.value=folder.path;
    document.forms[0].folderDocument.value=folder.path;
  }else{
    document.forms[0].hdnFolderDocument.value=document.forms[0].hdnRootFolder.value;
    document.forms[0].folderDocument.value=document.forms[0].hdnRootFolder.value;
  }
...
{ 
  ...
  if ((folderObj.isOpen) )				
    if (!(folderObj.isNextLevel) ){
      window.location.replace("folderDocSelectB4Action.do?currentFolderDocId4Select="+ folderId + "&treeAppend=true&foldersOnly=" + foldersOnly + "&openerControl=" + openerControl);
    }
}
