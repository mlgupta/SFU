...
<html:form action="userModifyAction.do" >
            ...
            <td height="460px" class="bdrLeftColor_336666 bdrBottomColor_336666 bdrRightColor_336666">
              ...
              <table width="508" border="0" align="center" cellspacing="8" class="bdrColor_336666">
                ...
                <tr>
                  ...
                  <td>
                    <html:text  property="txtUserId"  styleClass="bdrColor_336666" style="width:125px" readonly="true" maxlength="20" />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <html:checkbox  property="chkIsAdmin"  /></td>
                  </td>
                </tr>
              ...
              <!--user modify table ends-->
              <!--user create table ends-->
